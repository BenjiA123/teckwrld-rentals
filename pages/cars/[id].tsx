...
const CarPage:NextPage=(props:any) =>{
    ...
    const carData = [{"id":1,"name":"Dodge","fueled":false,"carGrade":1,"price":"3388","description":"sit amet sapien dignissim vestibulum vestibulum ante ipsum primis in faucibus"},
